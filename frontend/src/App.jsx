...
import {
  ...
  FiFileText, FiUser, FiShield, FiLogOut, FiBell
} from "react-icons/fi";
...
function Shell({ children }) {
  ...
  const logout = () => { clearUser(); navigate("/", { replace: true }); };
    ...
    <div className="app-shell">
      <aside className="sidebar-modern">
        ...
        <nav className="nav-list">
          ...
          <Item to="/communicate" icon={<FiBell />} label="Communicate" />
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/communicate" element={<ProtectedRoute><Shell><Communications/></Shell></ProtectedRoute>} />
